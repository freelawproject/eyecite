    ...
    def test_find_citations(self):
        ...
        test_pairs = (
            ...
            ("O'Connor v. Ortega (1987) 480 U.S. 709", [
                case_citation(volume='480', reporter='U.S.', year=1987,
                              page='709',
                              metadata={'plaintiff': "O'Connor", 'defendant': 'Ortega', 'year': '1987',
                                        'court': 'scotus'})]),
            ("People v. Mayfield (1997) 14 Cal.4th 668 [60 Cal.Rptr.2d 1,928 P.2d 485] ", [
                case_citation(volume='14', reporter='Cal.4th', year=1997,
                              page='668',
                              metadata={'plaintiff': "People",
                                        'defendant': 'Mayfield', 'year': '1997',
                                        }),
                case_citation(volume='60', reporter='Cal.Rptr.2d', year=1997,
                              page='1',
                              metadata={'plaintiff': "People",
                                        'defendant': 'Mayfield', 'year': '1997',
                                        }),
                case_citation(volume='928', reporter='P.2d', year=1997,
                              page='485',
                              metadata={'plaintiff': "People",
                                        'defendant': 'Mayfield', 'year': '1997',
                                        })
            ...
            ('In re K.F. (2009) 173 Cal.App.4th 655, 661', [
                case_citation(volume='173', reporter='Cal.App.4th', year=2009,
                              page='655',
                              metadata={'defendant': 'K.F.',
                                        'pin_cite': "661",
                                        'year': '2009'})]),
            ('This is a pure question of law, which we address without deference to the trial court’s ruling. (See In re K.F. (2009) 173 Cal.App.4th 655, 661 [92 Cal.Rptr.3d 784]; Yield Dynamics, Inc. v. TEA Systems Corp. (2007) 154 Cal.App.4th 547, 558 [66 Cal.Rptr.3d 1].)”', [
                case_citation(volume='173', reporter='Cal.App.4th', year=2009,
                              ...
                              metadata={'defendant': 'K.F.',
                                        'pin_cite': "661",
                                        'extra': '[92 Cal.Rptr.3d 784]',
                                        'year': '2009'}),
                case_citation(volume='92', reporter='Cal.Rptr.3d', year=2009,
                              page='784',
                              metadata={'defendant': 'K.F.',
                                        'extra': ']',
                                        'year': '2009'}),
                case_citation(volume='154', reporter='Cal.App.4th', year=2007,
                              page='547',
                              metadata={'defendant': 'TEA Systems Corp.',
                                        'plaintiff': 'Inc.',
                                        'pin_cite': "558",
                                        'year': '2009'}),
                case_citation(volume='66', reporter='Cal.Rptr.3d', year=2007,
                              page='1',
                              metadata={'defendant': 'TEA Systems Corp.',
                                        'plaintiff': 'Inc.',
                                        'year': '2009'}),
            ]),
            ("""(See, e.g., Coulter v. Superior Court (1978) 21 Cal.3d 144, 148 [145 Cal.Rptr. 534, 577 P.2d 669] [demurrer sustained to less than all causes of action; writ appropriate to "prevent a needless and expensive trial and reversal"]; """, [
                case_citation(volume='21', reporter='Cal.3d', year=1978,
                              page='144',
                              metadata={'defendant': 'Superior Court',
                                        'pin_cite': "148",
                                        'plaintiff': 'Coulter',
                                        'year': '1978'}),
                case_citation(volume='145', reporter='Cal.Rptr.', year=1978,
                              page='534',
                              metadata={'defendant': 'Superior Court',
                                        'plaintiff': 'Coulter',
                                        'year': '1978'}),
                case_citation(volume='577', reporter='P.2d', year=1978,
                              page='669',
                              metadata={'defendant': 'Superior Court',
                                        'plaintiff': 'Coulter',
                                        'year': '1978'}),
